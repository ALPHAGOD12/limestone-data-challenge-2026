...
**Finished runners up out of 200+ teams**
...
![NaN Heatmap](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/nan_heatmap.png?raw=true)
...
![Market Level](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/market_level.png?raw=true)
...
![Deviation Distribution](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/deviation_distribution.png?raw=true)
...
![NNLS R² Bar Plot](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/nnls_r2_barplot.png?raw=true)
...
![Sparse Fit col_11](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/sparse_fit_col_11.png?raw=true)
![Sparse Fit col_30](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/sparse_fit_col_30.png?raw=true)
![Sparse Fit col_42](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/sparse_fit_col_42.png?raw=true)
![Sparse Fit col_46](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/sparse_fit_col_46.png?raw=true)
![Sparse Fit col_48](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/sparse_fit_col_48.png?raw=true)
![Sparse Fit col_50](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/sparse_fit_col_50.png?raw=true)

**Sparse-formula residuals — confirming near-zero reconstruction error:**

![Sparse Residual col_11](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/sparse_residual_col_11.png?raw=true)
![Sparse Residual col_30](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/sparse_residual_col_30.png?raw=true)
![Sparse Residual col_42](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/sparse_residual_col_42.png?raw=true)
![Sparse Residual col_46](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/sparse_residual_col_46.png?raw=true)
![Sparse Residual col_48](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/sparse_residual_col_48.png?raw=true)
![Sparse Residual col_50](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/sparse_residual_col_50.png?raw=true)

**Final formula inspection — T2 coefficients predicted vs actual:**

![T2 Formula col_11](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/index_formula_col_11.png?raw=true)
![T2 Formula col_30](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/index_formula_col_30.png?raw=true)
![T2 Formula col_42](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/index_formula_col_42.png?raw=true)
![T2 Formula col_46](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/index_formula_col_46.png?raw=true)
![T2 Formula col_48](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/index_formula_col_48.png?raw=true)
![T2 Formula col_50](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/index_formula_col_50.png?raw=true)

**Index residuals — near-zero residuals confirm the formula accuracy:**

![Index Residual col_11](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/index_residual_col_11.png?raw=true)
![Index Residual col_30](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/index_residual_col_30.png?raw=true)

**T2 cross-validation — comparing time-domain and frequency-domain constituent weights:**

![T2 Comparison col_11](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/t2_comparison_col_11.png?raw=true)
![T2 Comparison col_30](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/t2_comparison_col_30.png?raw=true)
...
![Shared Trend Estimation](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/shared_trend_estimation.png?raw=true)

**Detrended time series (after removing shared trend) — isolating column-specific deviations:**

![Detrended col_00](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/detrended_col_00.png?raw=true)
...
![Periodic Columns](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/raw_periodic_columns.png?raw=true)
...
![Mechanism Breakdown](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/p2_mechanism_breakdown.png?raw=true)
![Mechanism Detail](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/p2_mechanism_detail.png?raw=true)

**Periodic prefill diagnostics — validating the periodic component extraction:**

![Periodic Prefill](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/p2_periodic_prefill.png?raw=true)
![Periodic Residual](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/p2_periodic_residual.png?raw=true)

**Imputed time series — sample columns (blue dots = observed, orange = imputed):**

![Imputed col_00](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/p2_imputed_col_00.png?raw=true)
![Imputed col_24](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/p2_imputed_col_24.png?raw=true)
![Imputed col_34](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/p2_imputed_col_34.png?raw=true)
![Imputed col_52](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/p2_imputed_col_52.png?raw=true)
...
![Temporal Weight Decay](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/temporal_weight_decay.png?raw=true)

**Deviation autocorrelation by lag** — lag-1 ≈ 0.77 across columns, validating the decay base:

![Deviation Autocorrelation](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/deviation_autocorrelation.png?raw=true)
...
![Intrinsic Curve Fit](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/intrinsic_curve_0.png?raw=true)
![Intrinsic Curve Residuals](https://github.com/ALPHAGOD12/limestone-data-challenge-2026/blob/main/docs/images/intrinsic_curve_1.png?raw=true)
