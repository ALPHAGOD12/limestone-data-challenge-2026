"""
Problem 5 (Alt): Limit order trading — buy from NaN columns with price + quantity.
...
print("Problem 5 Alt: Loading imputed data for deviation model training...")
...
print("Problem 5 Alt: Training deviation correlation models on imputed data...")
_dev_models = {}
...
if __name__ == '__main__':
    print("\n" + "=" * 60)
    print("BACKTEST: trading_problem_5 (ALT) on all historical rows")
    print("=" * 60)
    ...
    print(f"\n  Avg score/day (ours):  {total_score / max(n_traded,1):.2f}")
    print(f"  Avg score/day (oracle): {oracle_score / max(n_traded,1):.2f}")
